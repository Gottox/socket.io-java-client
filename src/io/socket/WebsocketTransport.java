...
class WebsocketTransport extends WebSocketClient implements IOTransport {
	...
	public static IOTransport create(URL url, IOConnection connection) {
		URI uri = URI.create(PATTERN_HTTP.matcher(url.toString()).replaceFirst("ws") + IOConnection.SOCKET_IO_1
	...
	public WebsocketTransport(URI uri, IOConnection connection) {
		...
		try {
			...
			throw new RuntimeException("Error while initiating websocket transport", e);
		}
	}
